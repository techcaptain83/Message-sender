...
const PrePageLoader = () => {
    return (
        <div className="absolute top-1/2 left-1/2 -mt-4 -ml-2 h-8 w-4 text-blue-600">
            <div className="absolute z-10 -ml-2 h-12 w-12 animate-bounce">
            ...
            <div className="absolute  h-12 w-12 animate-bounce border-l-2 border-gray-200" style={
                {
                    rotate: "-90deg"
                }
            }></div>
