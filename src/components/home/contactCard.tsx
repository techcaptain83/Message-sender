...
const ContactCard = ({ id, displayName, displayText, firstName, lastName, phoneNumber, countryCode }: IUser) => {
    ...
    return (
        <tr className="even:bg-gray-50">
            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3 flex items-center gap-4 w-fit ">
