...
import { BsCheckSquare, BsSendFill } from "react-icons/bs"
...
const ListsPart = () => {
    ...
    const handleNumInput = ({value}:{value:number}) => {
        setNum(value)
    }
    return (
        <div className='h-full bg-[#10131A] text-white'>
            ...
            <div className="h-[35%] w-full border-t-[1px] border-gray-400">
                <div className="flex flex-row items-center p-2 lg:p-4 justify-between lg:text-sm text-[9px]">
                    ...
                    <div className="flex flex-row gap-4 items-center">
                        ...
                        <div className="flex items-center flex-row gap-2">
                            ...
                            <NumInput handleChange={()=>handleNumInput} value={ num} defaultValue={10} />
                            <p>0  - 0 of 0</p>
                        </div>
                ...
                <div className='px-2 relative'>
                    ...
                    <button className='text-blue-500 absolute right-5 font-bold top-[55%] hover:bg-[#171C22] p-2 rounded-md'><BsSendFill /></button>
                </div>
            </div>
        </div>
    )
